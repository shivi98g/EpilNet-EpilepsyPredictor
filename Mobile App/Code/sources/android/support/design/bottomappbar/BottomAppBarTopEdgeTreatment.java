...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment {
    ...
    public void getEdgePath(float length, float interpolation, ShapePath shapePath) {
        ...
        float f2 = distanceX;
        shapePath2.addArc(leftRoundedCornerCircleX - roundedCornerOffset, 0.0f, leftRoundedCornerCircleX + roundedCornerOffset, roundedCornerOffset * 2.0f, 270.0f, cornerRadiusArcLength2);
        ...
        shapePath2.addArc(rightRoundedCornerCircleX - roundedCornerOffset, 0.0f, rightRoundedCornerCircleX + roundedCornerOffset, roundedCornerOffset * 2.0f, 270.0f - cornerRadiusArcLength2, cornerRadiusArcLength2);
        shapePath2.lineTo(f, 0.0f);
    }
