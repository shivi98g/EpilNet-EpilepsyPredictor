...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0044R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0044R.styleable.BottomAppBar, defStyleAttr, C0044R.style.Widget_MaterialComponents_BottomAppBar, new int[0]);
        ColorStateList backgroundTint = MaterialResources.getColorStateList(context, a, C0044R.styleable.BottomAppBar_backgroundTint);
        this.fabAlignmentMode = a.getInt(C0044R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.hideOnScroll = a.getBoolean(C0044R.styleable.BottomAppBar_hideOnScroll, false);
        a.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C0044R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        this.topEdgeTreatment = new BottomAppBarTopEdgeTreatment((float) a.getDimensionPixelOffset(C0044R.styleable.BottomAppBar_fabCradleMargin, 0), (float) a.getDimensionPixelOffset(C0044R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0), (float) a.getDimensionPixelOffset(C0044R.styleable.BottomAppBar_fabCradleVerticalOffset, 0));
    ...
    public void setFabDiameter(@C0017Px int diameter) {
