...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x001c A[Catch:{ IOException | XmlPullParserException -> 0x0044 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.support.design.chip.ChipDrawable createFromResource(android.content.Context r5, @android.support.annotation.XmlRes int r6) {
        /*
            android.content.res.Resources r0 = r5.getResources()     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            android.content.res.XmlResourceParser r0 = r0.getXml(r6)     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
        L_0x0008:
            int r1 = r0.next()     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            r2 = 2
        ...
        L_0x0012:
            ...
            org.xmlpull.v1.XmlPullParserException r2 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            java.lang.String r3 = "No start tag found"
            r2.<init>(r3)     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            throw r2     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
        L_0x001c:
            java.lang.String r2 = r0.getName()     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            java.lang.String r3 = "chip"
            boolean r2 = android.text.TextUtils.equals(r2, r3)     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            if (r2 != 0) goto L_0x0030
            org.xmlpull.v1.XmlPullParserException r2 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            java.lang.String r3 = "Must have a <chip> start tag"
            r2.<init>(r3)     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            throw r2     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
        L_0x0030:
            android.util.AttributeSet r2 = android.util.Xml.asAttributeSet(r0)     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            int r3 = r2.getStyleAttribute()     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            if (r3 != 0) goto L_0x003d
            int r4 = android.support.design.C0044R.style.Widget_MaterialComponents_Chip_Entry     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            r3 = r4
        L_0x003d:
            int r4 = android.support.design.C0044R.attr.chipStandaloneStyle     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            android.support.design.chip.ChipDrawable r4 = createFromAttributes(r5, r2, r4, r3)     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            return r4
        L_0x0044:
            r0 = move-exception
            ...
            r2.<init>()
            java.lang.String r3 = "Can't load chip resource ID #0x"
            r2.append(r3)
    ...
    private void loadFromAttributes(AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        setMaxWidth(a.getDimensionPixelSize(C0044R.styleable.Chip_android_maxWidth, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
        a.recycle();
    }
