...
public class MaterialCardView extends CardView {
    ...
    public MaterialCardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0044R.attr.materialCardViewStyle);
    }

    public MaterialCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0044R.styleable.MaterialCardView, defStyleAttr, C0044R.style.Widget_MaterialComponents_CardView, new int[0]);
