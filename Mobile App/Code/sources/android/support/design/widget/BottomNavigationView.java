...
public class BottomNavigationView extends FrameLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C0044R.attr.bottomNavigationStyle);
    }
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context, attrs, C0044R.styleable.BottomNavigationView, defStyleAttr, C0044R.style.Widget_Design_BottomNavigationView, C0044R.styleable.BottomNavigationView_itemTextAppearanceInactive, C0044R.styleable.BottomNavigationView_itemTextAppearanceActive);
        if (a.hasValue(C0044R.styleable.BottomNavigationView_itemIconTint)) {
            this.menuView.setIconTintList(a.getColorStateList(C0044R.styleable.BottomNavigationView_itemIconTint));
        } else {
            this.menuView.setIconTintList(this.menuView.createDefaultColorStateList(16842808));
        }
        setItemIconSize(a.getDimensionPixelSize(C0044R.styleable.BottomNavigationView_itemIconSize, getResources().getDimensionPixelSize(C0044R.dimen.design_bottom_navigation_icon_size)));
        if (a.hasValue(C0044R.styleable.BottomNavigationView_itemTextAppearanceInactive)) {
            setItemTextAppearanceInactive(a.getResourceId(C0044R.styleable.BottomNavigationView_itemTextAppearanceInactive, 0));
        }
        if (a.hasValue(C0044R.styleable.BottomNavigationView_itemTextAppearanceActive)) {
            setItemTextAppearanceActive(a.getResourceId(C0044R.styleable.BottomNavigationView_itemTextAppearanceActive, 0));
        }
        if (a.hasValue(C0044R.styleable.BottomNavigationView_itemTextColor)) {
            setItemTextColor(a.getColorStateList(C0044R.styleable.BottomNavigationView_itemTextColor));
        }
        if (a.hasValue(C0044R.styleable.BottomNavigationView_elevation)) {
            ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0044R.styleable.BottomNavigationView_elevation, 0));
        }
        setLabelVisibilityMode(a.getInteger(C0044R.styleable.BottomNavigationView_labelVisibilityMode, -1));
        setItemHorizontalTranslationEnabled(a.getBoolean(C0044R.styleable.BottomNavigationView_itemHorizontalTranslationEnabled, true));
        this.menuView.setItemBackgroundRes(a.getResourceId(C0044R.styleable.BottomNavigationView_itemBackground, 0));
        if (a.hasValue(C0044R.styleable.BottomNavigationView_menu)) {
            inflateMenu(a.getResourceId(C0044R.styleable.BottomNavigationView_menu, 0));
        }
        a.recycle();
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        divider.setBackgroundColor(ContextCompat.getColor(context, C0044R.color.design_bottom_navigation_shadow_color));
        divider.setLayoutParams(new FrameLayout.LayoutParams(-1, getResources().getDimensionPixelSize(C0044R.dimen.design_bottom_navigation_shadow_height)));
        addView(divider);
    }
