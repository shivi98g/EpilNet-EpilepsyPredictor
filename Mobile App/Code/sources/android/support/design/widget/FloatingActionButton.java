...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0044R.attr.floatingActionButtonStyle);
    }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0044R.styleable.FloatingActionButton, defStyleAttr, C0044R.style.Widget_Design_FloatingActionButton, new int[0]);
        this.backgroundTint = MaterialResources.getColorStateList(context, a, C0044R.styleable.FloatingActionButton_backgroundTint);
        this.backgroundTintMode = ViewUtils.parseTintMode(a.getInt(C0044R.styleable.FloatingActionButton_backgroundTintMode, -1), (PorterDuff.Mode) null);
        this.rippleColor = MaterialResources.getColorStateList(context, a, C0044R.styleable.FloatingActionButton_rippleColor);
        this.size = a.getInt(C0044R.styleable.FloatingActionButton_fabSize, -1);
        this.customSize = a.getDimensionPixelSize(C0044R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.borderWidth = a.getDimensionPixelSize(C0044R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(C0044R.styleable.FloatingActionButton_elevation, 0.0f);
        float hoveredFocusedTranslationZ = a.getDimension(C0044R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0f);
        float pressedTranslationZ = a.getDimension(C0044R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.compatPadding = a.getBoolean(C0044R.styleable.FloatingActionButton_useCompatPadding, false);
        this.maxImageSize = a.getDimensionPixelSize(C0044R.styleable.FloatingActionButton_maxImageSize, 0);
        MotionSpec showMotionSpec = MotionSpec.createFromAttribute(context, a, C0044R.styleable.FloatingActionButton_showMotionSpec);
        MotionSpec hideMotionSpec = MotionSpec.createFromAttribute(context, a, C0044R.styleable.FloatingActionButton_hideMotionSpec);
        a.recycle();
    ...
    public void setCustomSize(@C0017Px int size2) {
        if (size2 < 0) {
    ...
    private int getSizeDimension(int size2) {
        ...
        if (size2 != -1) {
            if (size2 != 1) {
                return res.getDimensionPixelSize(C0044R.dimen.design_fab_size_normal);
            }
            return res.getDimensionPixelSize(C0044R.dimen.design_fab_size_mini);
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0044R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = a.getBoolean(C0044R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
            a.recycle();
        }
