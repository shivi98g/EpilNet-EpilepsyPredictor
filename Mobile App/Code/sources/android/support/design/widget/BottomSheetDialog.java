...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    protected BottomSheetDialog(@NonNull Context context, boolean cancelable2, DialogInterface.OnCancelListener cancelListener) {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0044R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0044R.C0046id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0044R.C0046id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0044R.C0046id.touch_outside).setOnClickListener(new View.OnClickListener() {
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0044R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0044R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
