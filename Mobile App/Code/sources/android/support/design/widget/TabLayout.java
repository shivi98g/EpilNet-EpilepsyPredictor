...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0044R.attr.tabStyle);
    }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0044R.styleable.TabLayout, defStyleAttr, C0044R.style.Widget_Design_TabLayout, C0044R.styleable.TabLayout_tabTextAppearance);
        this.slidingTabIndicator.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabIndicatorHeight, -1));
        this.slidingTabIndicator.setSelectedIndicatorColor(a.getColor(C0044R.styleable.TabLayout_tabIndicatorColor, 0));
        setSelectedTabIndicator(MaterialResources.getDrawable(context, a, C0044R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorGravity(a.getInt(C0044R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(a.getBoolean(C0044R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabPaddingStart, this.tabPaddingStart);
        this.tabPaddingTop = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        this.tabTextAppearance = a.getResourceId(C0044R.styleable.TabLayout_tabTextAppearance, C0044R.style.TextAppearance_Design_Tab);
        TypedArray ta = context.obtainStyledAttributes(this.tabTextAppearance, C0395R.styleable.TextAppearance);
        try {
            this.tabTextSize = (float) ta.getDimensionPixelSize(C0395R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, ta, C0395R.styleable.TextAppearance_android_textColor);
            ta.recycle();
            if (a.hasValue(C0044R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, a, C0044R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C0044R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), a.getColor(C0044R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context, a, C0044R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(a.getInt(C0044R.styleable.TabLayout_tabIconTintMode, -1), (PorterDuff.Mode) null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, a, C0044R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = a.getInt(C0044R.styleable.TabLayout_tabIndicatorAnimationDuration, ANIMATION_DURATION);
            this.requestedTabMinWidth = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = a.getResourceId(C0044R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = a.getDimensionPixelSize(C0044R.styleable.TabLayout_tabContentStart, 0);
            this.mode = a.getInt(C0044R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = a.getInt(C0044R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = a.getBoolean(C0044R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = a.getBoolean(C0044R.styleable.TabLayout_tabUnboundedRipple, false);
            a.recycle();
            Resources res = getResources();
            this.tabTextMultiLineSize = (float) res.getDimensionPixelSize(C0044R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = res.getDimensionPixelSize(C0044R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            ta.recycle();
            throw th;
    ...
    class TabView extends LinearLayout {
        ...
        public final void update() {
            ...
            if (this.customView == null) {
                if (this.iconView == null) {
                    ImageView iconView2 = (ImageView) LayoutInflater.from(getContext()).inflate(C0044R.layout.design_layout_tab_icon, this, false);
                    addView(iconView2, 0);
                ...
                if (this.textView == null) {
                    TextView textView2 = (TextView) LayoutInflater.from(getContext()).inflate(C0044R.layout.design_layout_tab_text, this, false);
                    addView(textView2);
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (View.MeasureSpec.getMode(widthMeasureSpec) == 1073741824 && TabLayout.this.mode == 1 && TabLayout.this.tabGravity == 1) {
                ...
                int largestTabWidth2 = count;
                for (int i = 0; i < largestTabWidth2; i++) {
        ...
        public void animateIndicatorToPosition(int position, int duration) {
            ...
            C01231 r0 = new ValueAnimator.AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator animator) {
