...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable content, float radius, float shadowSize2, float maxShadowSize2) {
        super(content);
        this.shadowStartColor = ContextCompat.getColor(context, C0044R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C0044R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C0044R.color.design_fab_shadow_end_color);
    ...
    private void drawShadow(Canvas canvas) {
        ...
        if (this.contentBounds.height() - (2.0f * shadowOffset) > 0.0f) {
            z = true;
        }
        ...
        float shadowScaleBottom2 = shadowOffset / (shadowOffset + (this.rawShadowSize - (this.rawShadowSize * 1.0f)));
