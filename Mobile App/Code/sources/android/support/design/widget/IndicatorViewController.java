...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C0044R.dimen.design_textinput_caption_translate_y));
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.errorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.errorView.setId(C0044R.C0046id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean enabled) {
        if (this.helperTextEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.helperTextView.setId(C0044R.C0046id.textinput_helper_text);
                if (this.typeface != null) {
