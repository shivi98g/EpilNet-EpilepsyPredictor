...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            a = context.obtainStyledAttributes(attrs, C0031R.styleable.CoordinatorLayout, 0, C0031R.style.Widget_Support_CoordinatorLayout);
        } else {
            a = context.obtainStyledAttributes(attrs, C0031R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        int keylineArrayRes = a.getResourceId(C0031R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0031R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    public void onMeasure(int r37, int r38) {
        /*
            ...
            int r12 = android.support.p000v4.view.ViewCompat.getLayoutDirection(r36)
            r0 = 1
        ...
        L_0x0022:
            ...
            boolean r4 = android.support.p000v4.view.ViewCompat.getFitsSystemWindows(r36)
            if (r4 == 0) goto L_0x004b
            goto L_0x004c
        L_0x004b:
            r0 = 0
        ...
        L_0x0074:
            ...
            int r2 = android.support.p000v4.view.GravityCompat.getAbsoluteGravity(r2, r12)
            r2 = r2 & 7
            r25 = r3
            r3 = 3
        ...
        L_0x00cf:
            ...
            boolean r3 = android.support.p000v4.view.ViewCompat.getFitsSystemWindows(r0)
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        while (true) {
            ...
            if (view.getVisibility() == 8) {
                ...
                LayoutParams lp = (LayoutParams) view.getLayoutParams();
                int i4 = type;
                if (lp.isNestedScrollAccepted(i4) && (viewBehavior = lp.getBehavior()) != null) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(@NonNull Context context, @Nullable AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0031R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0031R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0031R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0031R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0031R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0031R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0031R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0031R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0031R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
