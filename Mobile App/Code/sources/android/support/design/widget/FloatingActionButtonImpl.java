...
class FloatingActionButtonImpl {
    ...
    public void onElevationsChanged(float elevation2, float hoveredFocusedTranslationZ2, float pressedTranslationZ2) {
        if (this.shadowDrawable != null) {
            this.shadowDrawable.setShadowSize(elevation2, this.pressedTranslationZ + elevation2);
            updatePadding();
        }
    }
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C0044R.animator.design_fab_show_motion_spec);
        }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C0044R.animator.design_fab_hide_motion_spec);
        }
    ...
    public CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable2.setGradientColors(ContextCompat.getColor(context, C0044R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0044R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0044R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0044R.color.design_fab_stroke_end_outer_color));
