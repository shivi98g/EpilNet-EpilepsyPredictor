...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attrs, 0, C0044R.style.Widget_Design_AppBarLayout);
        }
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0044R.styleable.AppBarLayout, 0, C0044R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, a.getDrawable(C0044R.styleable.AppBarLayout_android_background));
        if (a.hasValue(C0044R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0044R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0044R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) a.getDimensionPixelSize(C0044R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C0044R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C0044R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C0044R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C0044R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = a.getBoolean(C0044R.styleable.AppBarLayout_liftOnScroll, false);
        a.recycle();
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0044R.attr.state_liftable : -C0044R.attr.state_liftable;
        extraStates[1] = (!this.liftable || !this.lifted) ? -C0044R.attr.state_lifted : C0044R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0044R.attr.state_collapsible : -C0044R.attr.state_collapsible;
        extraStates[3] = (!this.liftable || !this.lifted) ? -C0044R.attr.state_collapsed : C0044R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C0044R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0044R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C0044R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(c, a.getResourceId(C0044R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, T child, View target, int dx, int dy, int[] consumed, int type) {
            ...
            if (i != 0) {
                ...
                if (min2 != max2) {
                    T t = child;
                    consumed[1] = scroll(coordinatorLayout, t, i, min2, max2);
                    stopNestedScrollIfNeeded(i, t, target, type);
                    return;
                }
            }
            T t2 = child;
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0044R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0044R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
