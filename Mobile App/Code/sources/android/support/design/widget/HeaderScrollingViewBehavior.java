...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if ((childLpHeight == -1 || childLpHeight == -2) && (header = findFirstDependency(parent.getDependencies(child))) != null) {
            ...
            parent.onMeasureChild(view, parentWidthMeasureSpec, widthUsed, View.MeasureSpec.makeMeasureSpec((availableHeight - header.getMeasuredHeight()) + getScrollRange(header), childLpHeight == -1 ? 1073741824 : Integer.MIN_VALUE), heightUsed);
            return true;
        }
        View view2 = child;
        return false;
