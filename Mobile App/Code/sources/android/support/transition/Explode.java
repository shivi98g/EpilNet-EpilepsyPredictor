...
public class Explode extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view, transitionValues, bounds.left, bounds.top, startX, endY + ((float) this.mTempLoc[1]), endX, endY, sDecelerate);
    }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        float endX = startX;
        float endY = startY;
        int[] interruptedPosition = (int[]) transitionValues.view.getTag(C0183R.C0185id.transition_position);
