...
class ImageViewUtils {
    ...
    static void startAnimateTransform(ImageView view) {
        if (Build.VERSION.SDK_INT < 21) {
            ...
            view.setTag(C0183R.C0185id.save_scale_type, scaleType);
            if (scaleType == ImageView.ScaleType.MATRIX) {
                view.setTag(C0183R.C0185id.save_image_matrix, view.getImageMatrix());
            } else {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            animator.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    ImageView.ScaleType scaleType = (ImageView.ScaleType) view.getTag(C0183R.C0185id.save_scale_type);
                    view.setScaleType(scaleType);
                    view.setTag(C0183R.C0185id.save_scale_type, (Object) null);
                    if (scaleType == ImageView.ScaleType.MATRIX) {
                        view.setImageMatrix((Matrix) view.getTag(C0183R.C0185id.save_image_matrix));
                        view.setTag(C0183R.C0185id.save_image_matrix, (Object) null);
                    }
