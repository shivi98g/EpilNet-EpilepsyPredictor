...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0183R.C0185id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0183R.C0185id.parent_matrix));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (!z || !ChangeTransform.this.mUseOverlay) {
                        view2.setTag(C0183R.C0185id.transition_transform, (Object) null);
                        view2.setTag(C0183R.C0185id.parent_matrix, (Object) null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view2.setTag(C0183R.C0185id.transition_transform, this.mTempMatrix);
                transforms.restore(view2);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0183R.C0185id.parent_matrix, endParentMatrix);
    ...
    private static class Transforms {
        ...
        public int hashCode() {
            int i = 0;
            int floatToIntBits = 31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * (this.mTranslationX != 0.0f ? Float.floatToIntBits(this.mTranslationX) : 0)) + (this.mTranslationY != 0.0f ? Float.floatToIntBits(this.mTranslationY) : 0))) + (this.mTranslationZ != 0.0f ? Float.floatToIntBits(this.mTranslationZ) : 0))) + (this.mScaleX != 0.0f ? Float.floatToIntBits(this.mScaleX) : 0))) + (this.mScaleY != 0.0f ? Float.floatToIntBits(this.mScaleY) : 0))) + (this.mRotationX != 0.0f ? Float.floatToIntBits(this.mRotationX) : 0))) + (this.mRotationY != 0.0f ? Float.floatToIntBits(this.mRotationY) : 0));
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0183R.C0185id.transition_transform, (Object) null);
            this.mView.setTag(C0183R.C0185id.parent_matrix, (Object) null);
        }
