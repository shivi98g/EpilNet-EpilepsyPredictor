...
public class Slide extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view2, transitionValues, position[0], position[1], startX, this.mSlideCalculator.getGoneY(viewGroup, view2), endX, endY, sDecelerate);
    }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view2, transitionValues, position[0], position[1], startX, startY, endX, this.mSlideCalculator.getGoneY(viewGroup, view2), sAccelerate);
    }
}
