...
public class ChangeBounds extends Transition {
    ...
    public Animator createAnimator(@NonNull ViewGroup sceneRoot, @Nullable TransitionValues startValues, @Nullable TransitionValues endValues) {
        ...
        if (startParent == null) {
                ...
                if (numChanges > 0) {
                    ...
                    if (!this.mResizeClip) {
                        ...
                        if (!startClip.equals(endClip)) {
                            ...
                            C01668 r0 = new AnimatorListenerAdapter() {
            ...
            ViewGroup viewGroup12 = sceneRoot;
            viewGroup12.getLocationInWindow(this.mTempLocation);
            ...
            final ViewGroup viewGroup13 = viewGroup12;
            ...
            C015910 r02 = new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
