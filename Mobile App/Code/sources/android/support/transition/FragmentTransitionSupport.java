...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public void scheduleRemoveTargets(Object overallTransitionObj, Object enterTransition, ArrayList<View> enteringViews, Object exitTransition, ArrayList<View> exitingViews, Object sharedElementTransition, ArrayList<View> sharedElementsIn) {
        ...
        ((Transition) overallTransitionObj).addListener(new Transition.TransitionListener() {
            public void onTransitionStart(@NonNull Transition transition) {
                if (obj != null) {
                    FragmentTransitionSupport.this.replaceTargets(obj, arrayList, (ArrayList<View>) null);
                }
                if (obj2 != null) {
                    FragmentTransitionSupport.this.replaceTargets(obj2, arrayList2, (ArrayList<View>) null);
                }
                if (obj3 != null) {
                    FragmentTransitionSupport.this.replaceTargets(obj3, arrayList3, (ArrayList<View>) null);
                }
            }
