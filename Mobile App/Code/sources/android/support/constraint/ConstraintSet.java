...
public class ConstraintSet {
    ...
    public void center(int centerID, int firstID, int firstSide, int firstMargin, int secondId, int secondSide, int secondMargin, float bias) {
        ...
        if (firstMargin < 0) {
            ...
            int i2 = centerID;
            connect(i2, 1, firstID, i, firstMargin);
            connect(i2, 2, secondId, secondSide, secondMargin);
            this.mConstraints.get(Integer.valueOf(centerID)).horizontalBias = f;
        } else if (i == 6 || i == 7) {
            int i3 = centerID;
            connect(i3, 6, firstID, i, firstMargin);
            connect(i3, 7, secondId, secondSide, secondMargin);
            this.mConstraints.get(Integer.valueOf(centerID)).horizontalBias = f;
        } else {
            int i4 = centerID;
            connect(i4, 3, firstID, i, firstMargin);
            connect(i4, 4, secondId, secondSide, secondMargin);
            this.mConstraints.get(Integer.valueOf(centerID)).verticalBias = f;
        }
    }
