...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C0395R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0395R.C0397id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0395R.C0397id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0395R.C0397id.action_bar));
        }
    }
