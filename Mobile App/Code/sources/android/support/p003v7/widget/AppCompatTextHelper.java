...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r19, int r20) {
        /*
            ...
            android.support.v7.widget.AppCompatDrawableManager r4 = android.support.p003v7.widget.AppCompatDrawableManager.get()
            int[] r5 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper
            r6 = 0
            android.support.v7.widget.TintTypedArray r5 = android.support.p003v7.widget.TintTypedArray.obtainStyledAttributes(r3, r1, r5, r2, r6)
            int r7 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper_android_textAppearance
            r8 = -1
            int r7 = r5.getResourceId(r7, r8)
            int r9 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper_android_drawableLeft
        ...
        L_0x0032:
            int r9 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper_android_drawableTop
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x0046:
            int r9 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper_android_drawableRight
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x005a:
            int r9 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper_android_drawableBottom
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x006e:
            ...
            int r9 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper_android_drawableStart
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x0088:
            int r9 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextHelper_android_drawableEnd
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x009c:
            ...
            int[] r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance
            android.support.v7.widget.TintTypedArray r5 = android.support.p003v7.widget.TintTypedArray.obtainStyledAttributes((android.content.Context) r3, (int) r7, (int[]) r8)
            if (r9 != 0) goto L_0x00c8
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_textAllCaps
            boolean r8 = r5.hasValue(r8)
            if (r8 == 0) goto L_0x00c8
            r8 = 1
            int r11 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_textAllCaps
        ...
        L_0x00c8:
            ...
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_android_textColor
            boolean r8 = r5.hasValue(r8)
            if (r8 == 0) goto L_0x00dd
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_android_textColor
            android.content.res.ColorStateList r12 = r5.getColorStateList(r8)
        L_0x00dd:
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_android_textColorHint
            boolean r8 = r5.hasValue(r8)
            if (r8 == 0) goto L_0x00eb
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_android_textColorHint
            android.content.res.ColorStateList r13 = r5.getColorStateList(r8)
        L_0x00eb:
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_android_textColorLink
            boolean r8 = r5.hasValue(r8)
        ...
        L_0x00fd:
            int[] r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance
            android.support.v7.widget.TintTypedArray r5 = android.support.p003v7.widget.TintTypedArray.obtainStyledAttributes(r3, r1, r8, r2, r6)
        ...
        L_0x0144:
            ...
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.TextAppearance_android_textSize
            boolean r8 = r5.hasValue(r8)
        ...
        L_0x0190:
            ...
            boolean r6 = android.support.p000v4.widget.AutoSizeableTextView.PLATFORM_SUPPORTS_AUTOSIZE
        ...
        L_0x01df:
            ...
            r17 = r5
        L_0x01e3:
            int[] r2 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextView
            android.support.v7.widget.TintTypedArray r2 = android.support.p003v7.widget.TintTypedArray.obtainStyledAttributes((android.content.Context) r3, (android.util.AttributeSet) r1, (int[]) r2)
            int r4 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextView_firstBaselineToTopHeight
            r5 = -1
            int r4 = r2.getDimensionPixelSize(r4, r5)
            int r6 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextView_lastBaselineToBottomHeight
            int r6 = r2.getDimensionPixelSize(r6, r5)
            int r8 = android.support.p003v7.appcompat.C0395R.styleable.AppCompatTextView_lineHeight
            int r8 = r2.getDimensionPixelSize(r8, r5)
            r2.recycle()
            if (r4 == r5) goto L_0x0206
            android.widget.TextView r15 = r0.mView
            android.support.p000v4.widget.TextViewCompat.setFirstBaselineToTopHeight(r15, r4)
        L_0x0206:
            if (r6 == r5) goto L_0x020d
            android.widget.TextView r15 = r0.mView
            android.support.p000v4.widget.TextViewCompat.setLastBaselineToBottomHeight(r15, r6)
        L_0x020d:
            if (r8 == r5) goto L_0x0214
            android.widget.TextView r5 = r0.mView
            android.support.p000v4.widget.TextViewCompat.setLineHeight(r5, r8)
        L_0x0214:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.AppCompatTextHelper.loadFromAttributes(android.util.AttributeSet, int):void");
    }

    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        String fontFamilyName;
        this.mStyle = a.getInt(C0395R.styleable.TextAppearance_android_textStyle, this.mStyle);
        boolean z = true;
        if (a.hasValue(C0395R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0395R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            int fontFamilyId = a.hasValue(C0395R.styleable.TextAppearance_fontFamily) ? C0395R.styleable.TextAppearance_fontFamily : C0395R.styleable.TextAppearance_android_fontFamily;
        ...
        } else if (a.hasValue(C0395R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            switch (a.getInt(C0395R.styleable.TextAppearance_android_typeface, 1)) {
                case 1:
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0395R.styleable.TextAppearance);
        if (a.hasValue(C0395R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0395R.styleable.TextAppearance_textAllCaps, false));
        }
        if (Build.VERSION.SDK_INT < 23 && a.hasValue(C0395R.styleable.TextAppearance_android_textColor) && (textColor = a.getColorStateList(C0395R.styleable.TextAppearance_android_textColor)) != null) {
            this.mView.setTextColor(textColor);
        }
        if (a.hasValue(C0395R.styleable.TextAppearance_android_textSize) && a.getDimensionPixelSize(C0395R.styleable.TextAppearance_android_textSize, -1) == 0) {
