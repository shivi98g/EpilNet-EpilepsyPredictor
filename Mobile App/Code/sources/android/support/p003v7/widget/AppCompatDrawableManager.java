...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = {C0395R.C0396drawable.abc_popup_background_mtrl_mult, C0395R.C0396drawable.abc_cab_background_internal_bg, C0395R.C0396drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {C0395R.C0396drawable.abc_textfield_activated_mtrl_alpha, C0395R.C0396drawable.abc_textfield_search_activated_mtrl_alpha, C0395R.C0396drawable.abc_cab_background_top_mtrl_alpha, C0395R.C0396drawable.abc_text_cursor_material, C0395R.C0396drawable.abc_text_select_handle_left_mtrl_dark, C0395R.C0396drawable.abc_text_select_handle_middle_mtrl_dark, C0395R.C0396drawable.abc_text_select_handle_right_mtrl_dark, C0395R.C0396drawable.abc_text_select_handle_left_mtrl_light, C0395R.C0396drawable.abc_text_select_handle_middle_mtrl_light, C0395R.C0396drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = {C0395R.C0396drawable.abc_textfield_search_default_mtrl_alpha, C0395R.C0396drawable.abc_textfield_default_mtrl_alpha, C0395R.C0396drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = {C0395R.C0396drawable.abc_btn_check_material, C0395R.C0396drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = {C0395R.C0396drawable.abc_ic_commit_search_api_mtrl_alpha, C0395R.C0396drawable.abc_seekbar_tick_mark_material, C0395R.C0396drawable.abc_ic_menu_share_mtrl_alpha, C0395R.C0396drawable.abc_ic_menu_copy_mtrl_am_alpha, C0395R.C0396drawable.abc_ic_menu_cut_mtrl_alpha, C0395R.C0396drawable.abc_ic_menu_selectall_mtrl_alpha, C0395R.C0396drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = {C0395R.C0396drawable.abc_tab_indicator_material, C0395R.C0396drawable.abc_textfield_search_material};
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (resId == C0395R.C0396drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0395R.C0396drawable.abc_cab_background_internal_bg), getDrawable(context, C0395R.C0396drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId, boolean failIfNotKnown, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable2;
        } else if (resId == C0395R.C0396drawable.abc_seekbar_track_material) {
            LayerDrawable ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (resId == C0395R.C0396drawable.abc_ratingbar_material || resId == C0395R.C0396drawable.abc_ratingbar_indicator_material || resId == C0395R.C0396drawable.abc_ratingbar_small_material) {
            LayerDrawable ld2 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0395R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(@android.support.annotation.NonNull android.content.Context r12, @android.support.annotation.DrawableRes int r13) {
        ...
        L_0x0084:
            ...
            android.support.v7.widget.AppCompatDrawableManager$InflateDelegate r8 = (android.support.p003v7.widget.AppCompatDrawableManager.InflateDelegate) r8     // Catch:{ Exception -> 0x00ac }
    ...
    private synchronized android.graphics.drawable.Drawable getCachedDrawable(@android.support.annotation.NonNull android.content.Context r5, long r6) {
        /*
            ...
            android.support.v4.util.LongSparseArray r0 = (android.support.p000v4.util.LongSparseArray) r0     // Catch:{ all -> 0x002d }
            r1 = 0
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int resId, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, resId)) {
            colorAttr = C0395R.attr.colorControlNormal;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, resId)) {
            colorAttr = C0395R.attr.colorControlActivated;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, resId)) {
            colorAttr = 16842801;
            colorAttrSet = true;
            tintMode = PorterDuff.Mode.MULTIPLY;
        } else if (resId == C0395R.C0396drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = 16842800;
            colorAttrSet = true;
            alpha = Math.round(40.8f);
        } else if (resId == C0395R.C0396drawable.abc_dialog_material_background) {
            colorAttr = 16842801;
            colorAttrSet = true;
        }
        if (!colorAttrSet) {
    ...
    static PorterDuff.Mode getTintMode(int resId) {
        if (resId == C0395R.C0396drawable.abc_switch_thumb_material) {
    ...
    public synchronized ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            if (resId == C0395R.C0396drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0395R.color.abc_tint_edittext);
            } else if (resId == C0395R.C0396drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0395R.color.abc_tint_switch_track);
            } else if (resId == C0395R.C0396drawable.abc_switch_thumb_material) {
                tint = createSwitchThumbColorStateList(context);
            } else if (resId == C0395R.C0396drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == C0395R.C0396drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context);
            } else if (resId == C0395R.C0396drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context);
            } else {
                if (resId != C0395R.C0396drawable.abc_spinner_mtrl_am_alpha) {
                    if (resId != C0395R.C0396drawable.abc_spinner_textfield_background_material) {
                        if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                            tint = ThemeUtils.getThemeAttrColorStateList(context, C0395R.attr.colorControlNormal);
                        } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                            tint = AppCompatResources.getColorStateList(context, C0395R.color.abc_tint_default);
                        } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                            tint = AppCompatResources.getColorStateList(context, C0395R.color.abc_tint_btn_checkable);
                        } else if (resId == C0395R.C0396drawable.abc_seekbar_thumb_material) {
                            tint = AppCompatResources.getColorStateList(context, C0395R.color.abc_tint_seek_thumb);
                        }
                    }
                }
                tint = AppCompatResources.getColorStateList(context, C0395R.color.abc_tint_spinner);
            }
            if (tint != null) {
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorAccent));
    }

    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int baseColor) {
        int[][] states = new int[4][];
        int[] colors = new int[4];
        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlHighlight);
        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0395R.attr.colorButtonNormal);
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        ColorStateList thumbColor = ThemeUtils.getThemeAttrColorStateList(context, C0395R.attr.colorSwitchThumbNormal);
        if (thumbColor == null || !thumbColor.isStateful()) {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0395R.attr.colorSwitchThumbNormal);
            int i = 0 + 1;
            states[i] = ThemeUtils.CHECKED_STATE_SET;
            colors[i] = ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlActivated);
            int i2 = i + 1;
            states[i2] = ThemeUtils.EMPTY_STATE_SET;
            colors[i2] = ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorSwitchThumbNormal);
            int i3 = i2 + 1;
        } else {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            ...
            colors[i4] = ThemeUtils.getThemeAttrColor(context, C0395R.attr.colorControlActivated);
            int i5 = i4 + 1;
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable d = getDrawable(context, C0395R.C0396drawable.abc_vector_test);
