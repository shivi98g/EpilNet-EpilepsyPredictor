...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0395R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0395R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0395R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0395R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0395R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = a.getInteger(C0395R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_titleMargin, 0);
        titleMargin = a.hasValue(C0395R.styleable.Toolbar_titleMargins) ? a.getDimensionPixelOffset(C0395R.styleable.Toolbar_titleMargins, titleMargin) : titleMargin;
        ...
        int marginStart = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0395R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int contentInsetLeft = a.getDimensionPixelSize(C0395R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0395R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0395R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = a.getDrawable(C0395R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0395R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0395R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0395R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        int i2 = titleMargin;
        setPopupTheme(a.getResourceId(C0395R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0395R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0395R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable drawable = navIcon;
        Drawable logo = a.getDrawable(C0395R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        Drawable drawable2 = logo;
        CharSequence logoDesc = a.getText(C0395R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        CharSequence charSequence = logoDesc;
        if (a.hasValue(C0395R.styleable.Toolbar_titleTextColor)) {
            CharSequence charSequence2 = navDesc;
            i = -1;
            setTitleTextColor(a.getColor(C0395R.styleable.Toolbar_titleTextColor, -1));
        } else {
            i = -1;
        }
        if (a.hasValue(C0395R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0395R.styleable.Toolbar_subtitleTextColor, i));
        }
        a.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0395R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0395R.attr.toolbarNavigationButtonStyle);
    ...
    public void onLayout(boolean r41, int r42, int r43, int r44, int r45) {
        /*
            r40 = this;
            r0 = r40
            int r1 = android.support.p000v4.view.ViewCompat.getLayoutDirection(r40)
            r2 = 1
            r3 = 0
        ...
        L_0x000d:
            ...
            r12[r2] = r3
            r12[r3] = r3
            int r13 = android.support.p000v4.view.ViewCompat.getMinimumHeight(r40)
        ...
        L_0x00da:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r3 = (android.support.p003v7.widget.Toolbar.LayoutParams) r3
        ...
        L_0x0142:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r15 = (android.support.p003v7.widget.Toolbar.LayoutParams) r15
        ...
        L_0x01de:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r10 = (android.support.p003v7.widget.Toolbar.LayoutParams) r10
            r31 = r3
            android.widget.TextView r3 = r0.mTitleTextView
        ...
        L_0x0268:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r6 = (android.support.p003v7.widget.Toolbar.LayoutParams) r6
