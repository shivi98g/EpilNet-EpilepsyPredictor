...
import android.support.p003v7.cardview.C0398R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0398R.attr.cardViewStyle);
    }
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attrs, C0398R.styleable.CardView, defStyleAttr, C0398R.style.CardView);
        if (a.hasValue(C0398R.styleable.CardView_cardBackgroundColor)) {
            valueOf = a.getColorStateList(C0398R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (hsv[2] > 0.5f) {
                i = getResources().getColor(C0398R.color.cardview_light_background);
            } else {
                i = getResources().getColor(C0398R.color.cardview_dark_background);
            }
            valueOf = ColorStateList.valueOf(i);
        }
        ColorStateList backgroundColor = valueOf;
        float radius = a.getDimension(C0398R.styleable.CardView_cardCornerRadius, 0.0f);
        float elevation = a.getDimension(C0398R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation = a.getDimension(C0398R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a.getBoolean(C0398R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a.getBoolean(C0398R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(C0398R.styleable.CardView_contentPadding, 0);
        this.mContentPadding.left = a.getDimensionPixelSize(C0398R.styleable.CardView_contentPaddingLeft, defaultPadding);
        this.mContentPadding.top = a.getDimensionPixelSize(C0398R.styleable.CardView_contentPaddingTop, defaultPadding);
        this.mContentPadding.right = a.getDimensionPixelSize(C0398R.styleable.CardView_contentPaddingRight, defaultPadding);
        this.mContentPadding.bottom = a.getDimensionPixelSize(C0398R.styleable.CardView_contentPaddingBottom, defaultPadding);
        float maxElevation2 = elevation > maxElevation ? elevation : maxElevation;
        this.mUserSetMinWidth = a.getDimensionPixelSize(C0398R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a.getDimensionPixelSize(C0398R.styleable.CardView_android_minHeight, 0);
        a.recycle();
    ...
    public void setContentPadding(@C0017Px int left, @C0017Px int top, @C0017Px int right, @C0017Px int bottom) {
