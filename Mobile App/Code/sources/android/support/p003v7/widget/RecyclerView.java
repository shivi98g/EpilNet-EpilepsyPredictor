...
import android.support.p003v7.recyclerview.C0401R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0401R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0401R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0401R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0401R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0401R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0401R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0401R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0401R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    public void smoothScrollBy(@C0017Px int dx, @C0017Px int dy) {
        smoothScrollBy(dx, dy, (Interpolator) null);
    }

    public void smoothScrollBy(@C0017Px int dx, @C0017Px int dy, @Nullable Interpolator interpolator) {
        if (this.mLayout == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
    ...
    public void offsetChildrenVertical(@C0017Px int dy) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void offsetChildrenHorizontal(@C0017Px int dx) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void onScrolled(@C0017Px int dx, @C0017Px int dy) {
    }
    ...
    static void clearNestedRecyclerViewIfNotNested(@android.support.annotation.NonNull android.support.p003v7.widget.RecyclerView.ViewHolder r3) {
        /*
        ...
        L_0x0024:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.RecyclerView.clearNestedRecyclerViewIfNotNested(android.support.v7.widget.RecyclerView$ViewHolder):void");
    }
    ...
    public static abstract class LayoutManager {
        ...
        public static int getChildMeasureSpec(int r7, int r8, int r9, int r10, boolean r11) {
            ...
            L_0x0043:
                ...
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(int, int, int, int, boolean):int");
        }
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0401R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0401R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0401R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0401R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0401R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0401R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0401R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0401R.dimen.fastscroll_margin));
    }
    ...
    public static abstract class SmoothScroller {
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0017Px int i, @C0017Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@C0017Px int dx, @C0017Px int dy) {
                this(dx, dy, Integer.MIN_VALUE, (Interpolator) null);
            }

            public Action(@C0017Px int dx, @C0017Px int dy, int duration) {
                this(dx, dy, duration, (Interpolator) null);
            }

            public Action(@C0017Px int dx, @C0017Px int dy, int duration, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0017Px int dx) {
                this.mChanged = true;
                this.mDx = dx;
            }
            ...
            public void setDy(@C0017Px int dy) {
                this.mChanged = true;
                this.mDy = dy;
            }
            ...
            public void update(@C0017Px int dx, @C0017Px int dy, int duration, @Nullable Interpolator interpolator) {
                this.mDx = dx;
                this.mDy = dy;
                this.mDuration = duration;
                this.mInterpolator = interpolator;
