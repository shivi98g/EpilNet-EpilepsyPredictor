...
class ItemTouchUIUtilImpl implements ItemTouchUIUtil {
    ...
    public void onDraw(Canvas c, RecyclerView recyclerView, View view, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        if (Build.VERSION.SDK_INT >= 21 && isCurrentlyActive && view.getTag(C0401R.C0403id.item_touch_helper_previous_elevation) == null) {
            ...
            view.setTag(C0401R.C0403id.item_touch_helper_previous_elevation, originalElevation);
        }
    ...
    public void clearView(View view) {
        if (Build.VERSION.SDK_INT >= 21) {
            Object tag = view.getTag(C0401R.C0403id.item_touch_helper_previous_elevation);
            if (tag != null && (tag instanceof Float)) {
                ViewCompat.setElevation(view, ((Float) tag).floatValue());
            }
            view.setTag(C0401R.C0403id.item_touch_helper_previous_elevation, (Object) null);
        }
