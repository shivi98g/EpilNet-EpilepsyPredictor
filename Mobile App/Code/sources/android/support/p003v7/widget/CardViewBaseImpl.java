        ...
        RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper() {
            public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
                ...
                if (cornerRadius >= 1.0f) {
                    ...
                    canvas2.drawRect((rectF.left + roundedCornerRadius) - 1.0f, rectF.top, (rectF.right - roundedCornerRadius) + 1.0f, rectF.top + roundedCornerRadius, paint);
                    canvas2.drawRect((rectF.left + roundedCornerRadius) - 1.0f, rectF.bottom - roundedCornerRadius, (rectF.right - roundedCornerRadius) + 1.0f, rectF.bottom, paint);
                }
                canvas2.drawRect(rectF.left, rectF.top + cornerRadius, rectF.right, rectF.bottom - cornerRadius, paint);
            }
        };
    }
