    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0395R.C0397id.topPanel) {
                    topPanel = child;
                } else if (id == C0395R.C0397id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0395R.C0397id.contentPanel && id != C0395R.C0397id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
