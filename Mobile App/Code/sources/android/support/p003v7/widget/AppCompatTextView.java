...
public class AppCompatTextView extends TextView implements TintableBackgroundView, AutoSizeableTextView {
    ...
    public void setFirstBaselineToTopHeight(@C0017Px @IntRange(from = 0) int firstBaselineToTopHeight) {
    ...
    public void setLastBaselineToBottomHeight(@C0017Px @IntRange(from = 0) int lastBaselineToBottomHeight) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0017Px @IntRange(from = 0) int lineHeight) {
