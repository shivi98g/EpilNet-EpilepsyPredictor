...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0395R.C0397id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0395R.C0397id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0395R.C0397id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0395R.C0397id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, C0395R.styleable.ActionBar, C0395R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0395R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0395R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0395R.attr.actionBarWidgetTheme, outValue, true);
