...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0395R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0395R.styleable.AlertDialog, C0395R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0395R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0395R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0395R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0395R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0395R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0395R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0395R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0395R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    private void setupView() {
        /*
            ...
            int r2 = android.support.p003v7.appcompat.C0395R.C0397id.parentPanel
            android.view.View r1 = r1.findViewById(r2)
            int r2 = android.support.p003v7.appcompat.C0395R.C0397id.topPanel
            android.view.View r2 = r1.findViewById(r2)
            int r3 = android.support.p003v7.appcompat.C0395R.C0397id.contentPanel
            android.view.View r3 = r1.findViewById(r3)
            int r4 = android.support.p003v7.appcompat.C0395R.C0397id.buttonPanel
            android.view.View r4 = r1.findViewById(r4)
            int r5 = android.support.p003v7.appcompat.C0395R.C0397id.customPanel
            android.view.View r5 = r1.findViewById(r5)
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
            r0.setupCustomContent(r5)
            int r6 = android.support.p003v7.appcompat.C0395R.C0397id.topPanel
            android.view.View r6 = r5.findViewById(r6)
            int r7 = android.support.p003v7.appcompat.C0395R.C0397id.contentPanel
            android.view.View r7 = r5.findViewById(r7)
            int r8 = android.support.p003v7.appcompat.C0395R.C0397id.buttonPanel
        ...
        L_0x0071:
            ...
            int r14 = android.support.p003v7.appcompat.C0395R.C0397id.textSpacerNoButtons
        ...
        L_0x009b:
            int r14 = android.support.p003v7.appcompat.C0395R.C0397id.titleDividerNoCustom
        ...
        L_0x00a8:
            ...
            int r1 = android.support.p003v7.appcompat.C0395R.C0397id.textSpacerNoTitle
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0395R.C0397id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0395R.C0397id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0395R.C0397id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0395R.C0397id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0395R.C0397id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0395R.C0397id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0395R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0395R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0395R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    ...
                    adapter2 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems) {
                    ...
                    adapter2 = new CursorAdapter(this.mContext, this.mCursor, false) {
