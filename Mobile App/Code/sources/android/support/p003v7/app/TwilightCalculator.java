...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        float n = (float) Math.round(((double) (daysSince2000 - f37J0)) - arcLongitude);
        float f = n;
        float f2 = daysSince2000;
        double solarTransitJ2000 = ((double) (f37J0 + n)) + arcLongitude + (0.0053d * Math.sin((double) meanAnomaly)) + (-0.0069d * Math.sin(2.0d * solarLng));
