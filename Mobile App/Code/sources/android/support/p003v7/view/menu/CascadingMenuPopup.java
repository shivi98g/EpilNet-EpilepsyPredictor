...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0395R.layout.abc_cascading_menu_item_layout;
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0395R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(C0395R.layout.abc_popup_menu_header_item_layout, listView, false);
    ...
    private android.view.View findParentViewForSubmenu(@android.support.annotation.NonNull android.support.p003v7.view.menu.CascadingMenuPopup.CascadingMenuInfo r11, @android.support.annotation.NonNull android.support.p003v7.view.menu.MenuBuilder r12) {
        /*
            r10 = this;
            android.support.v7.view.menu.MenuBuilder r0 = r11.menu
        ...
        L_0x000a:
            ...
            r4 = r6
            android.support.v7.view.menu.MenuAdapter r4 = (android.support.p003v7.view.menu.MenuAdapter) r4
            goto L_0x0029
        L_0x0025:
            r5 = 0
            r4 = r3
        ...
        L_0x002f:
            ...
            android.support.v7.view.menu.MenuItemImpl r9 = r4.getItem((int) r7)
        ...
        L_0x0055:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.view.menu.CascadingMenuPopup.findParentViewForSubmenu(android.support.v7.view.menu.CascadingMenuPopup$CascadingMenuInfo, android.support.v7.view.menu.MenuBuilder):android.view.View");
    }
