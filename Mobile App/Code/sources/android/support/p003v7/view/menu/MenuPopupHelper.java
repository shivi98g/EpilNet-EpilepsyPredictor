...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu) {
        this(context, menu, (View) null, false, C0395R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu, @NonNull View anchorView) {
        this(context, menu, anchorView, false, C0395R.attr.popupMenuStyle, 0);
    }
    ...
    private android.support.p003v7.view.menu.MenuPopup createPopup() {
        ...
        L_0x0020:
            ...
            int r5 = android.support.p003v7.appcompat.C0395R.dimen.abc_cascading_menus_min_smallest_width
