        ...
        while (true) {
            ...
            if (!stack.isEmpty()) {
                ...
                if (snake != null) {
                    ...
                    snake.f40x += range.oldListStart;
                    snake.f41y += range.newListStart;
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback updateCallback) {
            ...
            while (true) {
                ...
                if (snakeIndex2 >= 0) {
                    ...
                    int endX = snake.f40x + snakeSize2;
                    int endY2 = snake.f41y + snakeSize2;
                    if (endX < posOld2) {
                        endY = endY2;
                    ...
                    while (true) {
                        ...
                        if ((this.mOldItemStatuses[snake.f40x + i3] & 31) == 2) {
                            batchingCallback2.onChanged(snake.f40x + i3, 1, this.mCallback.getChangePayload(snake.f40x + i3, snake.f41y + i3));
                        }
                        i2 = i3 - 1;
                    }
                    posOld2 = snake.f40x;
