...
public final class ColorUtils {
    ...
    public static Color compositeColors(@NonNull Color foreground, @NonNull Color background) {
        ...
        Color s = Objects.equals(background.getColorSpace(), foreground.getColorSpace()) ? foreground : foreground.convert(background.getColorSpace());
    ...
    @FloatRange(from = 0.0d, mo110to = 1.0d)
    ...
    public static void RGBToHSL(@IntRange(from = 0, mo116to = 255) int r, @IntRange(from = 0, mo116to = 255) int g, @IntRange(from = 0, mo116to = 255) int b, @NonNull float[] outHsl) {
        float h;
        float s;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int color, @IntRange(from = 0, mo116to = 255) int alpha) {
    ...
    public static void RGBToLAB(@IntRange(from = 0, mo116to = 255) int r, @IntRange(from = 0, mo116to = 255) int g, @IntRange(from = 0, mo116to = 255) int b, @NonNull double[] outLab) {
    ...
    public static void RGBToXYZ(@IntRange(from = 0, mo116to = 255) int r, @IntRange(from = 0, mo116to = 255) int g, @IntRange(from = 0, mo116to = 255) int b, @NonNull double[] outXyz) {
        double[] dArr = outXyz;
        if (dArr.length != 3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, mo110to = 95.047d) double x, @FloatRange(from = 0.0d, mo110to = 100.0d) double y, @FloatRange(from = 0.0d, mo110to = 108.883d) double z, @NonNull double[] outLab) {
        if (outLab.length != 3) {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, mo110to = 100.0d) double l, @FloatRange(from = -128.0d, mo110to = 127.0d) double a, @FloatRange(from = -128.0d, mo110to = 127.0d) double b, @NonNull double[] outXyz) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, mo110to = 95.047d) double x, @FloatRange(from = 0.0d, mo110to = 100.0d) double y, @FloatRange(from = 0.0d, mo110to = 108.883d) double z) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, mo110to = 100.0d) double l, @FloatRange(from = -128.0d, mo110to = 127.0d) double a, @FloatRange(from = -128.0d, mo110to = 127.0d) double b) {
        double[] result = getTempDouble3Array();
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int color1, @ColorInt int color2, @FloatRange(from = 0.0d, mo110to = 1.0d) float ratio) {
    ...
    public static void blendHSL(@NonNull float[] hsl1, @NonNull float[] hsl2, @FloatRange(from = 0.0d, mo110to = 1.0d) float ratio, @NonNull float[] outResult) {
    ...
    public static void blendLAB(@NonNull double[] lab1, @NonNull double[] lab2, @FloatRange(from = 0.0d, mo110to = 1.0d) double ratio, @NonNull double[] outResult) {
        if (outResult.length != 3) {
