...
public class ViewCompat {
    ...
    public static void setPaddingRelative(@NonNull View view, @C0017Px int start, @C0017Px int top, @C0017Px int end, @C0017Px int bottom) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo110to = 1.0d) float value) {
        view.setAlpha(value);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View v, @NonNull OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0021R.C0023id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new ArrayMap<>();
                v.setTag(C0021R.C0023id.tag_unhandled_key_listeners, viewListeners);
            }
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0021R.C0023id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(C0021R.C0023id.tag_unhandled_key_listeners, viewListeners2);
        }
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m6at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0021R.C0023id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
            root.setTag(C0021R.C0023id.tag_unhandled_key_event_manager, manager2);
            return manager2;
        }
        ...
        private boolean onUnhandledKeyEvent(@NonNull View v, @NonNull KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0021R.C0023id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                return false;
            }
