...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @C0017Px int i2);
    ...
    public void populate(int newCurrentItem) {
        ...
        if (this.mAdapter == null) {
            ...
            if (curItem != null) {
                ...
                float leftWidthNeeded2 = clientWidth <= 0 ? 0.0f : (((float) getPaddingLeft()) / ((float) clientWidth)) + (2.0f - curItem.widthFactor);
                ...
                while (true) {
                    ...
                    if (extraWidthLeft < leftWidthNeeded2 || pos >= startPos2) {
                        ...
                        break;
                    } else if (pos != ii4.position || ii4.scrolling) {
                        leftWidthNeeded = leftWidthNeeded2;
                        pos--;
    ...
    public void onMeasure(int r23, int r24) {
        ...
        L_0x0040:
            ...
            android.support.v4.view.ViewPager$LayoutParams r10 = (android.support.p000v4.view.ViewPager.LayoutParams) r10
        ...
        L_0x0107:
            ...
            android.support.v4.view.ViewPager$LayoutParams r5 = (android.support.p000v4.view.ViewPager.LayoutParams) r5
    ...
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        ...
        L_0x0166:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.view.ViewPager.onTouchEvent(android.view.MotionEvent):boolean");
    }
