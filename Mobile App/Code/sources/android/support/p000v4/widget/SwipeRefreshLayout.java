...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void setSlingshotDistance(@C0017Px int slingshotDistance) {
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        this.mProgress.setProgressRotation((-0.25f + (0.4f * adjustedPercent) + (2.0f * tensionPercent)) * DRAG_RATE);
