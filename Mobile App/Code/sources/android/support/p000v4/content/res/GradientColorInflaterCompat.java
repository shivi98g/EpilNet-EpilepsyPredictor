...
final class GradientColorInflaterCompat {
    ...
    static android.graphics.Shader createFromXml(@android.support.annotation.NonNull android.content.res.Resources r4, @android.support.annotation.NonNull org.xmlpull.v1.XmlPullParser r5, @android.support.annotation.Nullable android.content.res.Resources.Theme r6) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x001a:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.content.res.GradientColorInflaterCompat.createFromXml(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.content.res.Resources$Theme):android.graphics.Shader");
    }
    ...
    static Shader createFromXmlInner(@NonNull Resources resources, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme2, attrs, C0021R.styleable.GradientColor);
        float startX = TypedArrayUtils.getNamedFloat(a, xmlPullParser, "startX", C0021R.styleable.GradientColor_android_startX, 0.0f);
        float startY = TypedArrayUtils.getNamedFloat(a, xmlPullParser, "startY", C0021R.styleable.GradientColor_android_startY, 0.0f);
        float endX = TypedArrayUtils.getNamedFloat(a, xmlPullParser, "endX", C0021R.styleable.GradientColor_android_endX, 0.0f);
        float endY = TypedArrayUtils.getNamedFloat(a, xmlPullParser, "endY", C0021R.styleable.GradientColor_android_endY, 0.0f);
        float centerX = TypedArrayUtils.getNamedFloat(a, xmlPullParser, "centerX", C0021R.styleable.GradientColor_android_centerX, 0.0f);
        float centerY = TypedArrayUtils.getNamedFloat(a, xmlPullParser, "centerY", C0021R.styleable.GradientColor_android_centerY, 0.0f);
        int type = TypedArrayUtils.getNamedInt(a, xmlPullParser, "type", C0021R.styleable.GradientColor_android_type, 0);
        int startColor = TypedArrayUtils.getNamedColor(a, xmlPullParser, "startColor", C0021R.styleable.GradientColor_android_startColor, 0);
        boolean hasCenterColor = TypedArrayUtils.hasAttribute(xmlPullParser, "centerColor");
        int centerColor = TypedArrayUtils.getNamedColor(a, xmlPullParser, "centerColor", C0021R.styleable.GradientColor_android_centerColor, 0);
        int endColor = TypedArrayUtils.getNamedColor(a, xmlPullParser, "endColor", C0021R.styleable.GradientColor_android_endColor, 0);
        String str = name;
        int tileMode = TypedArrayUtils.getNamedInt(a, xmlPullParser, "tileMode", C0021R.styleable.GradientColor_android_tileMode, 0);
        float startY2 = startY;
        float gradientRadius = TypedArrayUtils.getNamedFloat(a, xmlPullParser, "gradientRadius", C0021R.styleable.GradientColor_android_gradientRadius, 0.0f);
        a.recycle();
        ...
        switch (type) {
            ...
            default:
                ...
                int[] iArr4 = iArr3;
                float f2 = centerX;
                return new LinearGradient(startX, startY2, endX, endY, iArr4, colorStops.mOffsets, parseTileMode(tileMode));
        }
    }
    ...
    private static android.support.p000v4.content.res.GradientColorInflaterCompat.ColorStops inflateChildElements(@android.support.annotation.NonNull android.content.res.Resources r12, @android.support.annotation.NonNull org.xmlpull.v1.XmlPullParser r13, @android.support.annotation.NonNull android.util.AttributeSet r14, @android.support.annotation.Nullable android.content.res.Resources.Theme r15) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0036:
            ...
            android.content.res.TypedArray r3 = android.support.p000v4.content.res.TypedArrayUtils.obtainAttributes(r12, r15, r14, r3)
            int r7 = android.support.compat.C0021R.styleable.GradientColorItem_android_color
            boolean r7 = r3.hasValue(r7)
            int r8 = android.support.compat.C0021R.styleable.GradientColorItem_android_offset
            boolean r8 = r3.hasValue(r8)
            if (r7 == 0) goto L_0x006d
            if (r8 != 0) goto L_0x004d
            goto L_0x006d
        L_0x004d:
            int r9 = android.support.compat.C0021R.styleable.GradientColorItem_android_color
            r10 = 0
            int r9 = r3.getColor(r9, r10)
            int r10 = android.support.compat.C0021R.styleable.GradientColorItem_android_offset
            r11 = 0
