...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0021R.styleable.FontFamily);
        String authority = array.getString(C0021R.styleable.FontFamily_fontProviderAuthority);
        String providerPackage = array.getString(C0021R.styleable.FontFamily_fontProviderPackage);
        String query = array.getString(C0021R.styleable.FontFamily_fontProviderQuery);
        int certsId = array.getResourceId(C0021R.styleable.FontFamily_fontProviderCerts, 0);
        int strategy = array.getInteger(C0021R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int timeoutMs = array.getInteger(C0021R.styleable.FontFamily_fontProviderFetchTimeout, DEFAULT_TIMEOUT_MILLIS);
        array.recycle();
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0021R.styleable.FontFamilyFont);
        int weight = array.getInt(array.hasValue(C0021R.styleable.FontFamilyFont_fontWeight) ? C0021R.styleable.FontFamilyFont_fontWeight : C0021R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        boolean isItalic = 1 == array.getInt(array.hasValue(C0021R.styleable.FontFamilyFont_fontStyle) ? C0021R.styleable.FontFamilyFont_fontStyle : C0021R.styleable.FontFamilyFont_android_fontStyle, 0);
        int ttcIndexAttr = array.hasValue(C0021R.styleable.FontFamilyFont_ttcIndex) ? C0021R.styleable.FontFamilyFont_ttcIndex : C0021R.styleable.FontFamilyFont_android_ttcIndex;
        String variationSettings = array.getString(array.hasValue(C0021R.styleable.FontFamilyFont_fontVariationSettings) ? C0021R.styleable.FontFamilyFont_fontVariationSettings : C0021R.styleable.FontFamilyFont_android_fontVariationSettings);
        int ttcIndex = array.getInt(ttcIndexAttr, 0);
        int resourceAttr = array.hasValue(C0021R.styleable.FontFamilyFont_font) ? C0021R.styleable.FontFamilyFont_font : C0021R.styleable.FontFamilyFont_android_font;
