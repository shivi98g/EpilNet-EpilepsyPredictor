...
public final class ColorStateListInflaterCompat {
    ...
    private static android.content.res.ColorStateList inflate(@android.support.annotation.NonNull android.content.res.Resources r21, @android.support.annotation.NonNull org.xmlpull.v1.XmlPullParser r22, @android.support.annotation.NonNull android.util.AttributeSet r23, @android.support.annotation.Nullable android.content.res.Resources.Theme r24) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x002f:
            ...
            goto L_0x00eb
        L_0x004b:
            int[] r8 = android.support.compat.C0021R.styleable.ColorStateListItem
            r11 = r21
            r12 = r24
            android.content.res.TypedArray r8 = obtainAttributes(r11, r12, r0, r8)
            int r13 = android.support.compat.C0021R.styleable.ColorStateListItem_android_color
            r14 = -65281(0xffffffffffff00ff, float:NaN)
            int r13 = r8.getColor(r13, r14)
            r14 = 1065353216(0x3f800000, float:1.0)
            int r15 = android.support.compat.C0021R.styleable.ColorStateListItem_android_alpha
            ...
            goto L_0x007d
        L_0x006f:
            int r15 = android.support.compat.C0021R.styleable.ColorStateListItem_alpha
            boolean r15 = r8.hasValue(r15)
        ...
        L_0x008b:
            ...
            if (r2 == r7) goto L_0x00b5
            int r7 = android.support.compat.C0021R.attr.alpha
            if (r2 == r7) goto L_0x00b5
            int r7 = r1 + 1
            r19 = r7
            r7 = 0
        ...
        L_0x00d1:
            r7 = r6
        L_0x00d2:
            int[] r5 = android.support.p000v4.content.res.GrowingArrayUtils.append((int[]) r5, (int) r3, (int) r6)
            java.lang.Object[] r15 = android.support.p000v4.content.res.GrowingArrayUtils.append((T[]) r4, (int) r3, r2)
            r4 = r15
            int[][] r4 = (int[][]) r4
            int r3 = r3 + 1
            r1 = r16
        ...
        L_0x00fa:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.content.res.ColorStateListInflaterCompat.inflate(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
