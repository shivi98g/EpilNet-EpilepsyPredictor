...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    static final class C0210Op {
        ...
        C0210Op(int cmd2, Fragment fragment2) {
            this.cmd = cmd2;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0210Op op = this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
    ...
    private void doAddOp(int containerViewId, Fragment fragment, @Nullable String tag, int opcmd) {
        ...
        addOp(new C0210Op(opcmd, fragment));
    }
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        C0210Op thatOp = record.mOps.get(thoseOpIndex);
            ...
            switch (op.cmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new C0210Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                C0210Op removeOp = new C0210Op(3, old);
                ...
                case 6:
                    ...
                    if (op.fragment != oldPrimaryNav) {
                        ...
                        this.mOps.add(opNum, new C0210Op(9, op.fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    }
                case 8:
                    this.mOps.add(opNum, new C0210Op(9, oldPrimaryNav));
                    opNum++;
    ...
    private static boolean isFragmentPostponed(C0210Op op) {
