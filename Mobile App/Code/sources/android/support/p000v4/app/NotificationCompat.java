...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r20, int r21, boolean r22) {
            ...
            L_0x007c:
                ...
                int r11 = android.support.compat.C0021R.C0023id.right_icon
            ...
            L_0x00c5:
                ...
                int r11 = android.support.compat.C0021R.C0023id.icon
        ...
        private int calculateTopPadding() {
            ...
            int padding = resources.getDimensionPixelSize(C0021R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0021R.dimen.notification_top_pad_large_text);
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0021R.C0023id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            /* Code decompiled incorrectly, please refer to instructions dump. */
            public android.support.p000v4.app.NotificationCompat.Action build() {
                /*
                    r14 = this;
                ...
                L_0x0037:
                    ...
                    android.support.v4.app.RemoteInput[] r2 = (android.support.p000v4.app.RemoteInput[]) r2
                    r10 = r2
                L_0x0044:
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.support.p000v4.app.NotificationCompat.Action getAction(android.app.Notification r6, int r7) {
        /*
        ...
        L_0x002b:
            ...
            android.support.v4.app.NotificationCompat$Action r3 = android.support.p000v4.app.NotificationCompatJellybean.readAction(r3, r4, r5, r1)
            return r3
        L_0x0036:
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto L_0x0041
            android.support.v4.app.NotificationCompat$Action r0 = android.support.p000v4.app.NotificationCompatJellybean.getAction(r6, r7)
            return r0
        L_0x0041:
            r0 = 0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.app.NotificationCompat.getAction(android.app.Notification, int):android.support.v4.app.NotificationCompat$Action");
    }
