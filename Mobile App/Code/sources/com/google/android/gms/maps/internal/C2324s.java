...
public interface C2324s extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.s$a */
    public static abstract class C2325a extends Binder implements C2324s {

        /* renamed from: com.google.android.gms.maps.internal.s$a$a */
        private static class C2326a implements C2324s {

            /* renamed from: le */
            private IBinder f4330le;

            C2326a(IBinder iBinder) {
                this.f4330le = iBinder;
            }
            ...
            public void onStreetViewPanoramaChange(StreetViewPanoramaLocation streetViewPanoramaLocation) throws RemoteException {
                ...
                try {
                    ...
                    this.f4330le.transact(1, obtain, obtain2, 0);
        ...
        /* renamed from: bm */
        public static C2324s m6785bm(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C2324s)) ? new C2326a(iBinder) : (C2324s) queryLocalInterface;
        }
