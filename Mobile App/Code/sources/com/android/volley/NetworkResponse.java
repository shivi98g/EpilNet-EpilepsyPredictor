...
public class NetworkResponse {
    ...
    public NetworkResponse(byte[] data2) {
        this((int) ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, data2, false, 0, (List<Header>) Collections.emptyList());
    }

    @Deprecated
    public NetworkResponse(byte[] data2, Map<String, String> headers2) {
        this((int) ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, data2, headers2, false, 0);
    }
